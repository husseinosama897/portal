        ...
        <section class="content">
            ...
            <div class="section section-one">
                <div class="thumb-link">
                    <a class="popoverData" href="" data-tooltip="هو حساب يسجل جميع العمليات الخاصة بقائمة الدخل والمركز المالي ويساعد في استخراج رصيد كل حساب">
                        <img src="/newasset/assets/GL.png">
                        <p><b>دفتر الأستاذ</b></p>
                    </a>
                </div>
                <div class=" thumb-link">
                    <a class="popoverData" href="" rel="popover" data-tooltip=" هو سجل يسجل فيه جميع العمليات المالية حسب تسلسلها التاريخى، أولا بأول باتباع طريقة القيد المزدوج">
                ...
                <div class="thumb-link">
                    <a class="popoverData" href="" rel="popover" data-tooltip="هو كشف تظهر فيه مجاميع الاطراف المدينة ومجاميع الاطراف الدائنة للحسابات الظاهرة في دفتر الاستاذ، ومن المفترض أن تتساوى هذه المجاميع">
            ...
            <div class="section section-two">
                ...
                <div class="thumb-link">
                    <a class="popoverData ghcustom" href="" data-tooltip=" تقرير يبين كمية مبيعات و مشتريات المنتجات و مجموعها و متوسط سعر شراؤها و بيعها">
                        <img src="/newasset/assets/IR.png">
                        <p><b>ملخص المبيعات والمشتريات</b></p>
                    </a>
                </div>
                <div class="thumb-link">
                    <a class="popoverData" href="" data-tooltip=" تقرير يوضح المبالغ المستحقة لك حسب كل عميل">
                        <img src="/newasset/assets/ARC.png">
                        <p><b> حساب العملاء المدينون</b></p>
                    </a>
                </div>
                <div class="thumb-link">
                    <a class="popoverData" href="" data-tooltip="يعرفك الإقرار الضريبي على الضرائب المدفوعة والمستلمة والمستحقة">
            ...
            <div class="section section-three">
                <div class="thumb-link">
                    <a class="popoverData" href="" rel="popover" data-tooltip="هي قائمة تلخص أصول، وخصوم، وحقوق الملكية للمنشأة في تاريخ معين ">
                        <img src="/newasset/assets/BS.png">
                ...
                <div class="thumb-link">
                    <a class="popoverData" href="" data-tooltip="تقرير يوضح المبالغ المستحقة للموردين حسب كل مورد.لتستطيع التحكم في مستوى المديونية">
            ...
            <div class="section section-four">
                <div class="thumb-link">
                    <a class="popoverData" href="" data-tooltip="تقرير يوضح مبيعات كل منتج حسب الفترة المحددة مع امكانية المقارنة بفترات سابقة">
                ...
                <div class="thumb-link">
                    <a class="popoverData ghcustom" href="" data-tooltip="تقرير يوضح مشتريات كل منتج حسب الفترة المحددة مع امكانية المقارنة بفترات سابقة">
                        <img src="/newasset/assets/PSTL.png">
                        <p><b> تقرير مشتريات المنتجات</b></p>
                    </a>
                </div>
                <div class="thumb-link">
                    <a class="popoverData" href="" data-tooltip=" هو عرض بياني ومجدول لرصيد الحساب خلال فترة زمنية معينة يحددها المستخدم">
