                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <a class="dropdown-item" href="{{ route('managers.index_purchase_order_request') }}">
                                                    <i class="dropdown-icon fe fe-user"></i> managment
                                                </a>
                                                @endif
                                                @if(!empty(Auth::user()) && Auth::user()->laborer !== 1)
