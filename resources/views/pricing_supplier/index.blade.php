...
@section('title', '  تعسيرات الموردين')
@section('content')
<div id="app">
    ...
    <div class="col-12">
        <div class="page-title-box">
            <div class="page-title-right">
                <a class="btn btn-secondary" href="/pricing_suppliercreate" >Create</a>
            </div>
            <h4 class="page-title">pricing supplier </h4>
        </div>
    </div>
</div>

<pricing-table-user   :workflow="{{$workflow}}" ></pricing-table-user>
</div>
@section('style')
