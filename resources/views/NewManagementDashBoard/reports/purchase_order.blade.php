...
<body class="emp-body">
    <nav style="--bs-breadcrumb-divider: ''" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-angle-double-left client_primary_color"></i> <a href="#">ملخص المشتريات </a> </li>
        </ol>
    </nav>
...
<purchase-order-charts></purchase-order-charts>
</div>
