...
<head>
    ...
    <!-- font awosome file-->
    <link rel="stylesheet" href="newasset/css/all.min.css">
    <!--/normalize file -->
    <link rel="stylesheet" href="newasset/css/normalize.css">
    <!-- style sheet file-->
    <link rel="stylesheet" href="newasset/css/main.css">
...
<body class="emp-body">
    <nav style="--bs-breadcrumb-divider: ''" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-angle-double-left client_primary_color"></i> <a href="#">العملاء </a> </li>
        </ol>
    </nav>
