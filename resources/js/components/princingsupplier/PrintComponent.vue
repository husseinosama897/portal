        ...
        <table class="table table-bordered border-primary mb-2">
            <thead>
              ...
              <tbody>
                ...
                <tr   v-for=" (product,index) in  data2.attributes2" :key="product.id">
                     <td class="text-center fs-6">{{index + 1}}</td>
...
<td>{{note.dis}}</td>
    ...
    <div class="row align-items-center">
      ...
      <div :key="data.id"  class="col-2" v-for="data in data.princing_supplier_cycle" >
                                            <template  v-if="data.princing_supplier_comment_cycle && data.status == 1">
                                                    <div class="col-2">

                      <img :src="'/uploads/sign/'+data.princing_supplier_comment_cycle.user.sign" alt="" width="80">
                                        </div>
                                            </template>
                                                 <template  v-if="data.princing_supplier_comment_cycle && data.status == 2">
                                                    <div class="col-2">
...
this.payment.splice(index,1)
 ...
 this.data2 = this.data
          ...
          this.data2 =  this.$cookies.get('princing_supplier');
