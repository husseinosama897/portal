                              ...
                              <table    class="table table-responsive-md">
                                 <thead >
                                    <tr>
                                       ...
                                       <th ><strong>Hour(s)</strong></th>
                                       <th ><strong>minute(s)</strong></th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                  ...
                                  <input class="form-control" v-model="user.pivot.commitment">
                                       ...
                                       <td >
                                  <input class="form-control" v-model="user.pivot.time_difference">
                                       </td>

                                       
                                       <td >
                                  <input class="form-control" v-model="user.pivot.min">
                                       </td>
...
if(this.userz){
 ...
 if(this.images){
   ...
   formData.append('files-' + index, element);
     ...
     axios.post('/daily_report/updating/'+this.data.id,formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data' },
})
.then(res=>{
   this.$cookies.remove('daily_report')
   window.location.href = ('/daily_report/project_manager') 
})
.catch(error=>{
