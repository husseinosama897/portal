...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" :href="'/daily_report/preview/'+data.id">preview</a>
...
axios({
    url:'/daily_report/delete/'+data.id,
    method:'post',
}).then(res=>{
this.datas.data.splice(index,1)
    ...
    getResults(page = 1) {
		axios({
  method: 'post',
  url: '/daily_report/json_daily_Report?page=' + page,
    ...
    datajson() {
		axios({
  method: 'post',
  url: '/daily_report/json_daily_Report' ,
