...
<a @click="updateaccount2(f)"  class="dropdown-item" href="#">{{f.name}} - {{f.code}}</a>
                                ...
                                <div class="row lightorange p-2 ">
                                    <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
                                        <label for="birthday">Supplier</label>
                                    </div>
                                    <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
                                ...
                                <div class="row p-2"  v-for="(dep,index) in debtors" :key="index">
                                    <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12 ">
                                        <select class="form-select" v-model="dep.supplier_id" aria-label="Default select example">
                                            <option  v-for="cus in suppliers" :key="cus.id" :value="cus.id">  {{cus.customer_name ? cus.customer_name : cus.comp}} </option>
