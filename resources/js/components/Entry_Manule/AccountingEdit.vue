...
<ul dir="rtl"
>
<li   v-for="z in u.sub_account3" :key="z.id" @click="updateaccount4(dep,z)"  ><a  v-if="z.sub_account4.length <= 0" class="dropdown-item" href="#">{{z.name}} - {{z.code}}</a>
<ul dir="rtl"
>
<li   v-for="f in z.sub_account4" :key="f.id"  @click="updateaccount4(dep,f)"   >
<a  class="dropdown-item" href="#">{{f.name}} - {{f.code}}</a>
</li>
</ul>
                                        ...
                                        <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12 ">
                                            <input type="text" class="form-control"  v-model="dep.value" name="discription">
                                             ...
                                             <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12 ">
                                           <button type="button" @click="deletedep(index)" class="btn  btn-lightorange text-blue">حذف <i class="fas fa-plus"></i></button>
                                        </div>
                                    </div>
                                    <div class="row pt-4 text-end">
                                        <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12 ">
                                          <button  class="btn  btn-orange">متابعة

                                          </button>
                                        </div>
                                        <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12 ">
                                            <button type="button" @click="adddebtor()" class="btn  btn-lightorange text-blue">المزيد <i class="fas fa-plus"></i></button>
                                            </div>
                                    </div>
    </form>
...
console.log(dep)
Vue.set(dep,'sub_account4',null)
Vue.set(dep,'sub_account3',null)
if(acc.level == 4){
