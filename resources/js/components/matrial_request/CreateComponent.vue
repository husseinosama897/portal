                     ...
                     <div class="row">
                        <div class="col-xl-2 mb-2">
                           <div class="form-group">
                              <input type="text" class="form-control input-default " readonly v-model="ref" placeholder="Ref">
                           </div>
                        </div>
                        <div class="col-xl-2 mb-2">
                           <div class="form-group">
...
date:'',
subject:'',
content:'Reference to above mentioned subject we are requesting the material below , kindly note the following :- 1- All the requested material has been requested according to approved and according to shop drawings2- All the requested material we have been checked that not available on CP stores.Best Regards',
cc:'',
ref:this.refdata,
userz:[],
