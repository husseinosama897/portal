...
<div>
             ...
             <div class="card-header">
              ...
              <div class="row">
                <div class="col-12">
                  <a class="btn btn-primary" href="/contractorcpage">
                      ...
                      <table class="table datatable-button-print-basic">
                        ...
                        <tbody>
                          <tr v-for="(data,index) in data.data" :key="data.id">
                            ...
                            <td>{{data.comp ? data.comp : data.contractor_name }}</td>
                            ...
                            <td >{{data.country}}</td>
                            <td>
                              <a  :href="'/contractor/update/'+data.id" class="edit" >
