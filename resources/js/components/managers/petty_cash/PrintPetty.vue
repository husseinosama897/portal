    ...
    <div class="matrials">
            ...
            <thead>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center fs-6">{{data.total ? data.total : data.expected_amount}}</td>
                </tr>
              </tbody>
        </table>
        </div>
     ...
     <div class="qr row pt-4 pb-4">
        ...
        >
                ...
                <div :key="data.id" class="col-2" v-for="data in data.petty_cash_cycle" >
                    
                           <template v-if="data.comment_petty_cash_cycle && data.status == 1 ">
                           <div class="col-2" >
          <img :src="'/uploads/sign/'+data.comment_petty_cash_cycle.user.sign" alt="" width="80">
          </div>
                            </template>

                               <template v-if="data.comment_petty_cash_cycle && data.status == 2 ">
                           <div class="col-2" >
