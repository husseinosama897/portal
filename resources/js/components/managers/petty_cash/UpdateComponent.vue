...
<th>download</th>
                          ...
                          <tbody>
                            <tr v-for="cycle in data.petty_cash_attachment" :key="cycle.id" >
                              <td>{{cycle.path}}</td>
...
if(this.userz.length > 0){
    ...
    axios.post('/managers/action_petty_cash/'+this.data.id,formData, {
                    headers: {
...
this.material_avalibility = '',
this.subject = ''
 window.location.href = ('https://www.portal-cp.com/managers/index_petty_cash')
