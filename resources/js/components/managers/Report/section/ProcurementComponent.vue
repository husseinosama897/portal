     ...
     data(){
      ...
      growth_rate:'',
        series: [{
            ...
            axios({
                url:'/managers/report/department/procurement/json',
                method:'post',
                data:{
...
var actual = 0
   ...
   var saving_percentage = (Number(e.saving_percentage)   * 0.50)

  
  
  var total = (Number(percentage_performance) + Number(percentage_attendance) + Number(saving_percentage))
