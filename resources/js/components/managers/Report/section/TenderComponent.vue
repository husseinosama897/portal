     ...
     data(){
      ...
      growth_rate:'',
        series: [{
            ...
            axios({
                url:'/managers/report/department/tender/json',
                method:'post',
                data:{
...
var actual = 0
   ...
   var percentage_pricing = (Number(e.percentage_pricing)   * 0.60)

  var deal =     e.num_deal >= 1 ?  (Number(100)   * 0.20)   + (Number(e.num_deal) - 1  * 100 * 0.10    ) :   0
   deal = deal.toFixed(2)
