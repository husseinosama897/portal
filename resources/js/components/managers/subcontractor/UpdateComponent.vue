                  ...
                  <table class="table table-responsive-md">
                     ...
                     <tbody>
                        <tr v-for="(product,index) in scaling" :key="index">
                           <td style="width:1%;" ></td>
                           <td style="width:2%;"><strong>{{index}}</strong></td>
                           <td style="width:20%;">
...
if(this.userz.length > 0){
    ...
    axios.post('/managers/action_subcontractor_request/'+this.data.id,formData, {
                    headers: {
...
this.material_avalibility = '',
this.subject = ''
window.location.href = ('https://www.portal-cp.com/managers/index_subcontractor_request')
...
if(this.data.contract_withsubcontractor && this.data.contract_withsubcontractor.invoice ){
   this.invoice = this.data.contract_withsubcontractor.invoice 
}
...
invoices(){
   var total = 0
   if(this.data.contract_withsubcontractor.invoice && this.data.contract_withsubcontractor.invoice.length > 0){
      this.data.contract_withsubcontractor.invoice.forEach(e=>{
