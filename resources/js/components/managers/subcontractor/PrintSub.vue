        ...
        <table class="table table-bordered border-primary mb-2">
            <thead>
                <tr class="fw-md">
                    ...
                    <th scope="col" class="fw-md fs-6">current_qty</th>
              ...
              <tbody>
                ...
                <td class="text-center fs-6">{{product.name ? product.name : product.dis }}</td>
                  ...
                  <td class="text-center fs-6">{{product.current_qty}}</td>
                  <td class="text-center fs-6">{{product.current_qty + product.previous_qty}}</td>
