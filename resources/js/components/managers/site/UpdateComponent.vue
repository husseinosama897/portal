                        ...
                        <div class="card">
                           ...
                           <div class="card-body">
                                <div id="accordion-twelve" class="accordion accordion-rounded-stylish accordion-gradient">
                                    <div class="accordion__item" :key="data.id"  v-for="data in data.site_cycle">
                                        <template v-if="data.comment_site_cycle">
                                        ...
                                        <div id="gradient_collapseOne" class="collapse accordion__body show" data-parent="#accordion-twelve">
                                            <div class="accordion__body--text" >
                                               {{data.comment_site_cycle.content}}
                                            </div>
                                            
                                            <a  :href="'/uploads/site/'+cycle.path" v-for="cycle in data.comment_site_cycle.attachment_site_cycle" :key="cycle.id" download >  <span class="badge badge-pill badge-danger">
                                                file
                                                </span></a>
                                        </div>
                                        </template>
...
if(this.userz.length > 0){
    ...
    axios.post('/managers/action_site/'+this.data.id,formData, {
                    headers: {
...
this.material_avalibility = '',
this.subject = ''
window.location.href = ('https://www.portal-cp.com/managers/index_site')
