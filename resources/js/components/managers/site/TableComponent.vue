                                    ...
                                    <table class="table datatable-button-print-basic">
                                        ...
                                        <tbody>
                                            <tr v-for="data in datas.data "  :key="data.id">
                                                ...
                                                <td data-table="CODE">{{data.site.id}}</td>
                                                <td data-table="DATE">{{data.site.date}}</td>
                                                <td data-table="DESCRIPTION">{{data.site.subject}}</td>
...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" :href="'/managers/sitereturn/'+data.site.id">preview</a>
      <a class="dropdown-item" :href="'/managers/update_site/'+data.site.id">update</a>
...
this.datas.data.splice(index,1)
    ...
    getResults(page = 1) {
		axios({
  method: 'get',
  url: '/managers/returnjsonsite?page=' + page,
