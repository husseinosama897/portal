...
<th>download</th>
                          ...
                          <tbody>
                            <tr v-for="cycle in data.files" :key="cycle.id" >
                              ...
                              <td><a class="btn btn-danger"   :href="'/uploads/pricing_supplier/'+cycle.path"   download >download</a></td>
...
@input="checkerpayment(pay)"
                        ...
                        <div class="card">
                           ...
                           <div class="card-body">
                                <div id="accordion-twelve" class="accordion accordion-rounded-stylish accordion-gradient">
                                    <div class="accordion__item" :key="data.id"  v-for="data in data.pricing_supplier_cycle">
                                        <template v-if="data.pricing_supplier_comment_cycle">
                                        ...
                                        <div id="gradient_collapseOne" class="collapse accordion__body show" data-parent="#accordion-twelve">
                                            <div class="accordion__body--text" >
                                               {{data.pricing_supplier_comment_cycle.content}}
                                            </div>
                                            
                                            <a  :href="'/uploads/pricing_supplier/'+cycle.path" v-for="cycle in data.pricing_supplier_comment_cycle.files" :key="cycle.id" download >  <span class="badge badge-pill badge-danger">
                                                file
                                                </span></a>
                                        </div>
                                        </template>
 ...
 <div class="modal-dialog">
   <div class="modal-content">
     <form method="POST" v-on:submit.prevent="submit2()" enctype="multipart/form-data">
       ...
       <div class="modal-body">
         <div class="form-group">
           ...
           <input type="text" v-model="comp" class="form-control" placeholder="العودة" required>
         </div>
         <div class="form-group">
           <label class="label-req">اسم المورد </label>
           <input type="text" v-model="customer_name" class="form-control" placeholder="سالم السالم" required>
         </div>
         <div class="form-group">
       ...
       <select class="form-control" v-model="status">
         ...
         <div class="form-group">
           ...
           <input type="text"    v-model="country" class="form-control" placeholder="السعودية" value="السعوديه">
         </div>
       </div>
...
if(this.userz.length > 0){
    ...
    axios.post('/managers/pricing_supplier/updating/'+this.data.id,formData, {
                    headers: {
...
this.material_avalibility = '',
this.subject = ''
 window.location.href = ('/managers/pricing_supplier')
...
this.data.attributes.forEach(e=>{
  this.products.push({dis:e.pivot.dis,qty:e.pivot.qty,product_id:e.pivot.product_id,unit:e.pivot.unit,unit_price:e.pivot.unit_price,})
})
