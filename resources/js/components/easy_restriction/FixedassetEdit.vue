...
<div class="card-header"> إهلاك أصل ثابت  </div>                            
                                    <form method="POST" v-on:submit.prevent="submit()" enctype="multipart/form-data">
                                    <div class="row pt-4">
                                        <div class="col-lg-3 col-md-5 col-sm-5 col-xs-12">
                                            <label for="birthday">حساب الأصل الثابت:   </label>
                                            <p class="lightblue">تحديد نوع الأصل المهلك </p>
...
<a @click="updateaccount2(f)"  class="dropdown-item" href="#">{{f.name}} - {{f.code}}</a>
                                        ...
                                        <div class="row pt-1">
                                            <div class="col-lg-3 col-md-5 col-sm-5 col-xs-12">
                                                <label for="birthday">حساب الإهلاك:  </label>
                                                <p class="lightblue">تحديد الحساب المحمل به</p>
