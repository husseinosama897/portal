...
<div class="card">
  <div class="card-body">
    <div class="card-header">سحب المالك 

    </div>
                                    <form method="POST" v-on:submit.prevent="submit()" enctype="multipart/form-data">
                                    <div class="row pt-4">
                                        <div class="col-lg-3 col-md-5 col-sm-5 col-xs-12">
                                            <label for="birthday">نوع السحب </label>
                                            <p class="lightblue">من أي حساب قام المالك بالسحب؟ </p>
...
<a @click="updateaccount4(z)"  class="dropdown-item" href="#">{{f.name}} - {{f.code}}</a>
</li>
</ul>
                                        ...
                                        <div class="row pt-1">
                                            <div class="col-lg-3 col-md-5 col-sm-5 col-xs-12">
                                                <label for="birthday">حساب المالك  </label>
                                                <p class="lightblue">يفضل أن يكون حساب جاري باسم المالك</p>
...
>
<li   v-for="f in z.sub_account4" :key="f.id"   >
<a @click="updateaccount2(z)"  class="dropdown-item" href="#">{{f.name}} - {{f.code}}</a>
</li>
</ul>
