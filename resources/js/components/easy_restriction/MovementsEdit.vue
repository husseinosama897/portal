<template>
   <div class="container-lg  border-container">
                            <div class="m-3  row">
                                <div class="col-6">
                                        <a href="/selecteasyeasy_entries" class="btn btn-lightblue">
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="card-header">تحركات اموال
                                    ...
                                    <div class="row pt-4">
                                        <div class="col-lg-3 col-md-5 col-sm-5 col-xs-12">
                                            ...
                                            <p class="lightblue">الحساب الذي نقصت منه الاموال</p>
...
<a @click="updateaccount4(f)"  class="dropdown-item" href="#">{{f.name}} - {{f.code}}</a>
                                        ...
                                        <div class="row pt-1">
                                            <div class="col-lg-3 col-md-5 col-sm-5 col-xs-12">
                                                <label for="birthday">الي </label>
                                                <p class="lightblue">الحساب الذي زادت فيه الاموال</p>
...
<a @click="updateaccount2(f)"  class="dropdown-item" href="#">{{f.name}} - {{f.code}}</a>
                                        ...
                                        <div class="row pt-4">
                                            ...
                                            <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12 mt-2">
                                                <input type="text" class="form-control"  v-model="value" placeholder="اكتب قيمة القيد"
                                                name="discription">
