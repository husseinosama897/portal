...
newData.push({  role:e.role, time: time , name:e.name ,id:e.id,Deduction:Absence , contract:e.contract , salaryperHour:salaryperHour ,salaryPerDay:salaryPerDay,overtime:overtime ,amount:amount })
...
let vm = []
    ...
    getResults(page = 1) {
		axios({
  method: 'post',
  url: '/profile/jsontimesheet?page=' + page,
data:{
