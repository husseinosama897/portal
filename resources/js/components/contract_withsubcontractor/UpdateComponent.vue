...
<th>download</th>
                        ...
                        <tbody>
                          <tr v-for="cycle in data.files" :key="cycle.id" >
                            ...
                            <td><a class="btn btn-danger"   :href="'/uploads/contract_withsubcontractor/'+cycle.path"   download >download</a></td>
                  ...
                  <table class="table table-responsive-md">
                     ...
                     <tbody>
                        <tr v-for="(condition,index) in conditions" :key="index">
                           ...
                           <td style="width:30%;">
                              <textarea v-model="condition.condition" class="form-control">
                              </textarea>
                           </td>
  ...
  border: none; 
      ...
      ">
      <iframe :src="'/uploads/contract_withsubcontractor/'+path" style="width: 100%; height: 100%"  class="embed-responsive-item" title="Iframe Example"></iframe> 
    </div>
  </div>
</div>
...
choice:[],
to:'',
files:this.data.contract_withsubcontractor_attachment,
contentmanager:'',
...
if(this.project_id){
    ...
    axios.post('/cws/updating/'+this.data.id,formData, {
                    headers: {
