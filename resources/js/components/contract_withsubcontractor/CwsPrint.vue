...
{{data2.ref}}
         ...
         {{data2.date}}
          ...
          <div class="mb-3 row align-items-center">
            <h1 class="title col-4 col-sm-1">contractor</h1>
               <span class="t-points">  : </span>
            <div class="col-6 col-sm-4 fw-md" v-if="data2.contractor">
                <span>{{ data2.contractor.contractor_name ? data2.contractor.contractor_name : data2.contractor.comp  }}</span>
            </div>

            <div class="col-6 col-sm-4 fw-md" v-else>
                <span>{{ data2.contractor_name  }}</span>
            </div>
          </div>
 ...
 <tr  v-for=" (condition,index) in  data2.condition" :key="condition.id">
                            ...
                            <td class="text-center fs-6">{{condition.condition ? condition.condition : condition.dis  }}</td>
                </tr>
              </tbody>
        </table>
        </div>
...
this.subject = ''
 ...
 this.data2 = this.data
          ...
          this.data2 =  this.$cookies.get('cws');
