                           ...
                           <td  data-table="ACTION">
                              <div class="dropdown">
                                 ...
                                 <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" :href="'/user/purchasereturn/'+po.id">preview</a>
...
updating:{},
           ...
           series: [
                    {  name: 'budget',
            data: [this.budget_expenses.po_budget]
          }, {
            name: 'expenses',
            data: [this.expenses]
          }, 
        ...
        chartOptions: {
            ...
            xaxis: {
              categories: ['purchase order', 'expenses'],
            },
            yaxis: {
              title: {
                text: '$ (thousands)'
