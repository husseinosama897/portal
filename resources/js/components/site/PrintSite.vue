   ...
   <div class="qr row pt-4 pb-4">
     ...
     <div class="row"
        >
           ...
           <div :key="data.id"  class="col-2" v-for="data in data.site_cycle" >
                                            <template v-if="data.comment_site_cycle && data.status == 1">
                                               <div class="col-2" >
                      <img :src="'/uploads/sign/'+data.comment_site_cycle.user.sign" alt="" width="80">
                                       </div>
                                       
                                       </template>

                                            <template v-if="data.comment_site_cycle && data.status == 2">
                                               <div class="col-2" >
...
this.payment.splice(index,1)
 ...
 this.data2 = this.data
          ...
          this.data2 =  this.$cookies.get('site');
