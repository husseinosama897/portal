                  ...
                  <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                     ...
                     <tbody>
                        <tr v-for="data in datas.data" :key="data.id">
                           ...
                           <td data-table="subject">{{data.subject}}</td>
                           ...
                           <td data-table="salary">{{data.salary}}</td>
                           ...
                           <td  data-table="ACTION">
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                       <a class="dropdown-item" :href="'/joboffer/preview/'+data.id">preview</a>
                                       <a class="dropdown-item" :href="'/joboffer/update/'+data.id">update</a>
