...
<th>download</th>
  ...
  border: none; 
      ...
      ">
      <iframe :src="'/uploads/joboffer/'+path" style="width: 100%; height: 100%"  class="embed-responsive-item" title="Iframe Example"></iframe> 
    </div>
  </div>
</div>
                  </div>
...
axios.post('/joboffer/updating/'+this.data.id,formData, {
                  headers: {
